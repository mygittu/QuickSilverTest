...
${OBJECTDIR}/RPQTree.o: RPQTree.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RPQTree.o RPQTree.cpp

${OBJECTDIR}/SimpleEstimator.o: SimpleEstimator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SimpleEstimator.o SimpleEstimator.cpp

${OBJECTDIR}/SimpleEvaluator.o: SimpleEvaluator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SimpleEvaluator.o SimpleEvaluator.cpp

${OBJECTDIR}/SimpleGraph.o: SimpleGraph.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SimpleGraph.o SimpleGraph.cpp
